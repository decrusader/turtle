...
local programs = {
    ...
    {name = "Debug Status Editor", url = "https://raw.githubusercontent.com/decrusader/turtle/refs/heads/main/StartupProgrammas/MasterComputer/debug_status.lua?token=GHSAT0AAAAAADCDTGAPIRUGXSGXPRF3Z4FO2BITJVQ"} 
}
